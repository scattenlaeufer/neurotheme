...
<?php
	/*
	 * This is the top menu, which should contain a search fild
	 * and the container for a custom menu called Top Menu.
	 */
?>
<div class='top_menu'>
...
<div id='breadcrumb_widget'>
	<ul>
<?php
	if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('Breadcrumb Widget Area') ) :
	endif;
?>
	</ul>
</div>
