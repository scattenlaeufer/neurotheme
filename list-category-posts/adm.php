...
foreach ($this->catlist->get_categories_posts() as $single){
  ...
  $lcp_display_output .= "<div class='lcp_post'>";

  //Show the title and link to the post:
  $lcp_display_output .= $this->get_post_title($single, 'h3', 'lcp_post');

  //Show comments:
  $lcp_display_output .= $this->get_comments($single);

  //Show author
  $lcp_display_output .= '<div class="lcp_meta">geschrieben von ' . $this->get_author($single);

  //Show date:
  $lcp_display_output .= ', veröffentlicht am ' . $this->get_date($single) . '</div>';
